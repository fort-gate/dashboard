...
export declare const networks: {
    readonly standalone: {
        ...
        readonly contractId: "CAYMAMOC3HGCA2STL44IJ5PAZ5R4FIX4RN2SRQ27ZTE6JX63MGKRKSZ5";
    };
};
...
export interface Client {
     ...
     */
    make_guess: ({ user, will_rise, amount }: {
        user: string;
        will_rise: boolean;
        amount: i128;
    }, options?: {
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        make_guess: (json: string) => AssembledTransaction<Result<boolean, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
        verify_guess: (json: string) => AssembledTransaction<Result<boolean, import("@stellar/stellar-sdk/contract").ErrorMessage>>;
